...
class AlexNet(tf.keras.Model):
    def __init__(self):
        ...
        self.conv2 = tf.keras.layers.Conv2D(256, 5, activation="relu", kernel_initializer=initializer,
                                            bias_initializer=bias, padding="SAME")
        # Output: 27
        # Maxpool: 27 / 2 = 13.5 = ~13

        self.conv3 = tf.keras.layers.Conv2D(384, 3, activation="relu", kernel_initializer=initializer,
                                            bias_initializer=bias0, padding="SAME")
        # Output: 13

        self.conv4 = tf.keras.layers.Conv2D(384, 3, activation="relu", kernel_initializer=initializer,
                                            bias_initializer=bias, padding="SAME")
        # Output: 13

        self.conv5 = tf.keras.layers.Conv2D(256, 3, activation="relu", kernel_initializer=initializer,
                                            bias_initializer=bias, padding="SAME")
        # Output: 13
        ...
        self.fc3 = tf.keras.layers.Dense(1000, activation="softmax", kernel_initializer=initializer,
